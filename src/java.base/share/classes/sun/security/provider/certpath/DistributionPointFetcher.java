...
public class DistributionPointFetcher {
  ...
  public static Collection<X509CRL> getCRLs(X509CRLSelector selector,
    ...
    try {
      ...
      for (Iterator<DistributionPoint> t = points.iterator(); t.hasNext()
   ...
   *                            from one of the GeneralNames and no other CRLs are
   *                            retrieved from
   *                            the other GeneralNames. If more than one
   *                            GeneralName throws an
   *                            exception then the one from the last GeneralName
   *                            is thrown.
   */
   ...
   *                            one of the CertStores and no other CRLs are
   *                            retrieved from
   *                            the other CertStores. If more than one CertStore
   *                            throws an
   *                            exception then the one from the last CertStore is
   *                            thrown.
   */
